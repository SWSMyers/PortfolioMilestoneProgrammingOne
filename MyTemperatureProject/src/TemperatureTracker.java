...
public class TemperatureTracker {
    public static void main(String[] args) {
        ...
        // Assuming we have the temperature data, otherwise we would need to collect it
        for (int i = 0; i < temperatures.length; i++) {
            // Placeholder for actual average temperature data
        ...
        if ("year".equalsIgnoreCase(input)) {
            ...
            if (monthIndex != -1) {
                System.out.println("Average temperature for " + months[monthIndex] + ": " + temperatures[monthIndex] + "°C");
            } else {
